...
<head>
    ...
    <title>Reserva confirmada #{{ $code }}</title>
</head>

<body style="font-family: Arial, sans-serif; color:#111; line-height: 1.4;">
    <div style="max-width: 640px; margin: 0 auto; padding: 24px;">
        <h2 style="margin: 0 0 8px;">Reserva confirmada</h2>
        <p style="margin: 0 0 16px; color:#555;">
            Tu reserva fue confirmada. Guarda este código: <strong>#{{ $code }}</strong>
        </p>
        ...
        <p style="margin: 16px 0 0; color:#777; font-size: 12px;">
            Este correo es una confirmación de reserva y no reemplaza una boleta/factura.
        </p>
    </div>
</body>
